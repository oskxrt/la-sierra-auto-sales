    ...
    <section class="visit-section section" id="contact" aria-labelledby="visit-title">
      <div class="shell visit-grid">
        <div class="visit-media">
          <img src="./assets/hero-la-sierra.webp?v=20260918-cinematic" alt="Exterior of La Sierra Auto Sales in Las Vegas" loading="lazy" decoding="async">
    ...
    <footer class="site-footer">
      <div class="shell site-footer__top">
        <div class="site-footer__brand">
          <img src="./assets/la-sierra-logo-clean.webp" alt="LA SIERRA AUTO SALES" width="220" height="126">
